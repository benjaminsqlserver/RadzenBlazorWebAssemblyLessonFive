...
namespace CaApp
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<CaApp.Data.ConDataContext>(options =>
            {
              options.UseSqlServer(Configuration.GetConnectionString("conDataConnection"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ApplicationIdentityDbContext identityDbContext)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                oDataBuilder.EntitySet<CaApp.Models.ConData.Country>("Countries");
                oDataBuilder.EntitySet<CaApp.Models.ConData.DeviceCode>("DeviceCodes");
                oDataBuilder.EntitySet<CaApp.Models.ConData.Gender>("Genders");
                oDataBuilder.EntitySet<CaApp.Models.ConData.PersistedGrant>("PersistedGrants");
                oDataBuilder.EntitySet<CaApp.Models.ConData.SchoolClass>("SchoolClasses");
                oDataBuilder.EntitySet<CaApp.Models.ConData.Student>("Students");
