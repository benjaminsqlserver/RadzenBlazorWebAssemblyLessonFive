...
namespace CaApp
{
    public partial class ExportConDataController : ExportController
    {
        ...
        public FileStreamResult ExportSchoolClassesToCSV(string fileName = null)
        {
            return ToCSV(ApplyQuery(context.SchoolClasses, Request.Query), fileName);
        }

        [HttpGet("/export/ConData/schoolclasses/excel")]
        [HttpGet("/export/ConData/schoolclasses/excel(fileName='{fileName}')")]
        public FileStreamResult ExportSchoolClassesToExcel(string fileName = null)
        {
            return ToExcel(ApplyQuery(context.SchoolClasses, Request.Query), fileName);
        }
