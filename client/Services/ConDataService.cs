...
namespace CaApp
{
    public partial class ConDataService
    {
        ...
        public async System.Threading.Tasks.Task<ODataServiceResult<Models.ConData.SchoolClass>> GetSchoolClasses(string filter = default(string), string orderby = default(string), string expand = default(string), int? top = default(int?), int? skip = default(int?), bool? count = default(bool?), string format = default(string))
        {
            ...
            return await response.ReadAsync<ODataServiceResult<Models.ConData.SchoolClass>>();
        }
        partial void OnCreateSchoolClass(HttpRequestMessage requestMessage);


        public async System.Threading.Tasks.Task<Models.ConData.SchoolClass> CreateSchoolClass(Models.ConData.SchoolClass schoolClass = default(Models.ConData.SchoolClass))
        {
            var uri = new Uri(baseUri, $"SchoolClasses");
            ...
            return await response.ReadAsync<Models.ConData.SchoolClass>();
        }
        ...
        public async System.Threading.Tasks.Task<HttpResponseMessage> DeleteSchoolClass(int? id = default(int?))
        {
        ...
        partial void OnGetSchoolClassById(HttpRequestMessage requestMessage);


        public async System.Threading.Tasks.Task<Models.ConData.SchoolClass> GetSchoolClassById(int? id = default(int?))
        {
            var uri = new Uri(baseUri, $"SchoolClasses({id})");

            var httpRequestMessage = new HttpRequestMessage(HttpMethod.Get, uri);

            OnGetSchoolClassById(httpRequestMessage);
